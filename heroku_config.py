...
class Var(object):
    ...
    LESS_SPAMM = os.environ.get("LESS_SPAMM", None), 
    HEROKU_API_KEY = os.environ.get("HEROKU_API_KEY", None)
    HEROKU_APP_NAME = os.environ.get("HEROKU_APP_NAME", None)
    TG_BOT_TOKEN_BF_HER = os.environ.get("TG_BOT_TOKEN_BF_HER", None)
    # Send .get_id in any channel to fill this value.
    GROUP_ID = int(os.environ.get("GROUP_ID", -100))
    PLUGIN_CHANNEL = os.environ.get("PLUGIN_CHANNEL", f"{GROUP_ID}")
    PRIVATE_GROUP_BOT_API_ID = os.environ.get("PRIVATE_GROUP_BOT_API_ID", f"{GROUP_ID}")
    ...
    if AUTH_TOKEN_DATA is not None:
        ...
        t_file.close()
    PRIVATE_GROUP_ID = os.environ.get("PRIVATE_GROUP_ID", f"{GROUP_ID}")
    ...
    JOCASTA_PRO = os.environ.get("JOCASTA_PRO", "YES")
